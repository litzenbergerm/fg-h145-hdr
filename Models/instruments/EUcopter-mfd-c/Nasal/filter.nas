...
var Filter = {
    ...
    register: func (ob, fu, y=0, pg=nil ) {
       # this works (surprisingly) also for methods that take a single argument
       append(me.callbacks, [ob, fu, [0,y], 0, pg]);
    },
    register_y: func (ob, fu, x=0, pg=nil ) {
       append(me.callbacks, [ob, fu, [x,0], 1, pg]);
    },
    get: func() {
       return me.val;
    },
